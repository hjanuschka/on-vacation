...
export async function fetchVacationMd(owner, repo) {
  // Use GitHub API instead of raw.githubusercontent.com for reliability
  // This endpoint returns file content and works well from serverless functions
  const url = `https://api.github.com/repos/${owner}/${repo}/contents/VACATION.md`;
  try {
    ...
    console.error(`Fetch error for ${owner}/${repo}:`, err.message);
  }
