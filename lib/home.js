  ...
  <div class="container">
    ...
    <div class="terminal-window">
      ...
      <div class="terminal-content">
        ...
        <div class="step">
          ...
          <span>Include a <code>&#96;&#96;&#96;vacajson</code> schedule block</span>
        </div>
        <div class="step">
    ...
    <div class="ascii-box">
      ...
      <div class="ascii-box-content">
        <div class="tabs">
          <button class="tab active" onclick="switchTab(event, 'tab-daterange')">Date Range</button>
          ...
          <button class="tab" onclick="switchTab(event, 'tab-full')">Full VACATION.md</button>
        </div>

        <div id="tab-daterange" class="tab-panel active">
